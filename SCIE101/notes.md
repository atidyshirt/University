...
- Tried to stucture scientific revolutions and how they happened
  ...
  5. Believed that we had to wait for old scientists to die in order to have a chance of scientific revolution
  6. eventually if we fix enough problems with our theory, we can achieve scientific revolution
...
- Scientific frame of mind: come up with a _good_ explanation
...
- The universe was created by a badly inebriated invisible and undetectible being _Alien_
...
> To say that an argument is _deductively valid_ is to say that it is impossible for its conclusion to be false if its premises are all true
...
> To say that an argument is _inductively strong_ is to say that it is improbable, but not impossible for its conclusion to be false if its
...
Whakapapa, means _Genealogical table_
...
Located within a Maori perspective: takanga (process) whakapapa (geneology) and te aro.

#### Presentation Instructions

In what circumstances should communities seek advice from scientists for new initative?
